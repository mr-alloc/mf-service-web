...
import {ref} from "vue";
import {FamilyMemberInfo, ResponseBody} from "@/classes/api-spec/family/GetFamilyMembersOwn";
...
export const useFamilyMemberInfoStore = defineStore('familyMemberInfo', () => {
    const familyMemberInfo = ref<FamilyMemberInfo>(FamilyMemberInfo.ofDefault());
